    ...
    function renderProducts() {
        ...
        products.forEach(product => {
            ...
            div.innerHTML = `
                ...
                <button onclick="addToCart(${product.id})" class="py-2 px-4 bg-rose-500 hover:bg-rose-600 text-white border-none rounded cursor-pointer transition-colors duration-200 self-center w-full sm:w-auto mt-auto">Add to Cart</button>
            `;
            ...
            Object.keys(productCounts).forEach(key => {
                ...
                if (product) {
                    ...
                    li.innerHTML = `
                        ...
                        <button onclick="removeFromCart(${product.id})" class="ml-4 py-1 px-3 bg-rose-600 hover:bg-rose-700 text-white text-xs border-none rounded cursor-pointer transition-colors duration-200 flex-shrink-0">Remove One</button>
                    `;
